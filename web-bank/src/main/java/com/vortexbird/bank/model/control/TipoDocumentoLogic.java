...
import com.vortexbird.bank.dto.mapper.ITipoDocumentoMapper;
    ...
    */
    ...
    public void saveTipoDocumento(TipoDocumento entity)
        ...
        try {
            ...
            if (getTipoDocumento(entity.getTdocId()) != null) {
    ...
    public void deleteTipoDocumento(TipoDocumento entity)
        ...
        if (entity.getTdocId() == null) {
            throw new ZMessManager().new EmptyFieldException("tdocId");
        }

        List<Cliente> clientes = null;

        try {
            clientes = clienteDAO.findByProperty("tipoDocumento.tdocId",
                    entity.getTdocId());
    ...
    public TipoDocumento getTipoDocumento(Long tdocId)
        ...
        try {
            entity = tipoDocumentoDAO.findById(tdocId);
        } catch (Exception e) {
